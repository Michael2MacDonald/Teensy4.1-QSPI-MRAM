#******************************************************************************
# Generated by VisualTeensy V1.2.0 on 9/21/2021 at 8:05 PM
#
# Board              Teensy 4.1
# USB Type           Serial
# CPU Speed          600 MHz
...
DEFINES     := -D__IMXRT1062__ -DTEENSYDUINO=153 -DARDUINO_TEENSY41 -DARDUINO=10813 # Teensy 4.1
...
$(CORE_LIB) : $(CORE_OBJ)
	...
	@$(AR) $(AR_FLAGS) $@ $^
	@echo $(COL_OK)Core built successfully &&echo.
